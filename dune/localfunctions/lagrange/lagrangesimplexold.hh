...
#ifndef DUNE_LOCALFUNCTIONS_LAGRANGE_LAGRANGESIMPLEX_OLD_HH
#define DUNE_LOCALFUNCTIONS_LAGRANGE_LAGRANGESIMPLEX_OLD_HH
...
namespace Dune { namespace Impl_
{
...
namespace Dune
{
  ...
  class LagrangeSimplexLocalFiniteElementOld
  {
  public:
    /** \brief Export number types, dimensions, etc.
     */
    using Traits = LocalFiniteElementTraits<Impl_::LagrangeSimplexLocalBasis<D,R,d,k>,
                                            Impl_::LagrangeSimplexLocalCoefficients<d,k>,
                                            Impl_::LagrangeSimplexLocalInterpolation<Impl_::LagrangeSimplexLocalBasis<D,R,d,k> > >;

    /** Default-construct the finite element */
    LagrangeSimplexLocalFiniteElementOld() {}

    /** \brief Constructs a finite element given a vertex reordering
     * */
    template<typename VertexMap>
    LagrangeSimplexLocalFiniteElementOld(const VertexMap& vertexmap)
    ...
    static constexpr std::size_t size ()
    {
      return Impl_::LagrangeSimplexLocalBasis<D,R,d,k>::size();
    }
  ...
  private:
    Impl_::LagrangeSimplexLocalBasis<D,R,d,k> basis_;
    Impl_::LagrangeSimplexLocalCoefficients<d,k> coefficients_;
    Impl_::LagrangeSimplexLocalInterpolation<Impl_::LagrangeSimplexLocalBasis<D,R,d,k> > interpolation_;
  };

}        // namespace Dune

#endif   // DUNE_LOCALFUNCTIONS_LAGRANGE_LAGRANGESIMPLEX_OLD_HH
